...
const Skill_box = () => {
    ...
    return (
        <div className="w-full flex justify-center items-center">
            ...
            <div className="xl:w-[60%] 2xl:w-[70%] xl:flex xl:flex-row xl:justify-evenly mt-10 mb-40 ml:flex ml:flex-col ml:w-[90%] ml:items-center mm:flex mm:flex-col mm:w-[90%] mm:items-center">
