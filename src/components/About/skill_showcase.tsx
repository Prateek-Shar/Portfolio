        ...
        <div className="2xl:max-ll:w-[65%] xl:w-[70%] 2xl:w-[70%] xl:flex xl:flex-col mb-20 bg-[#e0e4eb] shadow-2xl rounded-4xl ml:flex ml:flex-col ml:w-[90%] mm:w-[90%]">
            ...
            <div className="w-full flex justify-center flex-col items-center mt-10 ">
                ...
                <div className="w-[80%] flex justify-evenly xl:flex ml:hidden mm:hidden mt-4 mb-2">
                    <div className="w-[12%] bg-[#e9ecef] rounded-[10px] flex shadow-2xs py-1.5">
                        <div className="w-[65%] flex justify-center items-center">
                            <p className="font-Poppins ml:text-[14px] mm:text-[14px] text-[#282c31] xl:text-[16px]">Redis</p>
                        </div>

                        <div className="w-[20%] flex items-center justify-center">
                            <img src={redis} className=""/>
                        </div>
                    </div>  
                </div>
                ...
                xl:hidden mt-4">
                    <div className="w-[30%] bg-[#e9ecef] rounded-[10px] flex">
                        <div className="w-[75%] flex justify-center items-center pt-2 pb-2">
                            <p className="font-Poppins ml:text-[14px] mm:text-[14px] text-[#282c31] xl:text-[12px]">Redis</p>
                        </div>
