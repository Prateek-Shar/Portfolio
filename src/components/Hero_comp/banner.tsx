...
const Banner = () => {
    ...
    return (
        ...
        <div className="w-full relative bg-[#e0e4eb] overflow-hidden">
            ...
            <div className="2xl:max-ll:ml-2 2xl:w-[42%] xl:w-[44.5%] flex flex-row-reverse xl:justify-normal xl:mt-35 ml:w-[80%] ml:mt-20 mm:mt-15">
            ...
            <div className="2xl:max-ll:w-[30%] 2xl:max-ll:ml-110 2xl:w-[40%] xl:flex xl:items-center xl:flex-row-reverse xl:ml-85 2xl:ml-81 mt-10 ml:w-[90%] ml:ml-0 ml:flex ml:flex-row-reverse mm:flex mm:justify-center ">
                <div className="ll:w-full 2xl:w-[90%]  xl:w-full ml:w-[72%] mm:w-[80%] flex ml:flex ml:justify-center ml:items-center xl:mr-6 2xl:mr-0">
            ...
            <div className="2xl:max-ll:w-[33%] 2xl:max-ll:ml-85 xl:w-[40%] xl:ml-65 2xl:ml-60 flex flex-row-reverse ml:w-[55%] mm:w-[80%] mm:flex mm:flex-row mm:justify-center ml:ml-9 xl:mt-4">
            ...
            <div className="2xl:max-ll:ml-41 2xl:w-[57%] 2xl:ml-30 xl:w-[75%] xl:flex xl:flex-row-reverse xl:ml-0 xl:justify-normal mt-10 ml:w-[90%] ml:flex ml:justify-center mm:flex mm:justify-center ml:ml-3">
