...
const Banner = () => {
    ...
    return (
        ...
        <div className="w-full relative bg-[#e0e4eb] overflow-hidden">
            ...
            <div className="2xl:w-[42%] xl:w-[44.5%] flex flex-row-reverse xl:justify-normal xl:mt-35 ml:w-[80%] ml:mt-20 mm:mt-15">
            ...
            <div className="xl:w-[40%] xl:flex xl:items-center xl:flex-row-reverse xl:ml-85 mt-10 ml:w-[90%] ml:ml-0 ml:flex ml:flex-row-reverse mm:flex mm:justify-center ">
                <div className="2xl:w-[70%] xl:w-[90%] ml:w-[72%] mm:w-[80%] flex ml:flex ml:justify-center ml:items-center xl:mr-6 2xl:mr-0">
            ...
            <div className="xl:w-[45%] xl:ml-55 flex flex-row-reverse ml:w-[55%] mm:w-[80%] mm:flex mm:flex-row mm:justify-center ml:ml-9 xl:mt-4">
                <div className="2xl:w-[36%] xl:w-[45%] relative xl:mr-10 ml:w-[82%] ml::mr-0 mm:w-[70%]">
            ...
            <div className="2xl:w-[35.5%] xl:w-[37%] xl:flex xl:flex-row-reverse xl:justify-normal mt-22 xl:mt-20 ml:w-[50%] ml:hidden ml:justify-center ml:items-center mm:w-[60%] mm:flex mm:justify-center mm:mt-15">
            ...
            <div className="w-full ml:hidden xl:flex xl:mt-17 mm:hidden 2xl:flex 2xl:mt-37" />
