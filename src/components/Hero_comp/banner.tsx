...
const Banner = () => {
    ...
    return (
        ...
        <div className="w-full relative bg-[#e0e4eb] overflow-hidden">
            ...
            <div className="2xl:w-[35.5%] xl:w-[37%] xl:hidden xl:flex-row-reverse xl:justify-normal mt-22 xl:mt-20 ml:w-[50%] ml:hidden ml:justify-center ml:items-center mm:w-[60%] mm:flex mm:justify-center mm:mt-15">
