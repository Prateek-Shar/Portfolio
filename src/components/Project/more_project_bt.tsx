...
const More_project_bt = () => {
    ...
    return (
        ...
        <div className="2xl:max-ll:w-[18%] shadow-2xs xl:w-[23%] 2xl:w-[21%] xl:flex xl:bg-[#e9ecef] xl:rounded-[10px] xl:justify-center xl:items-center xl:mt-2 xl:mb-2 xl:hover:cursor-pointer flex bg-[#e9ecef] rounded-[10px] mt-2 mb-2 hover:cursor-pointer ml:w-[50%] mm:w-[70%]" onClick={ClickToGithub} onMouseEnter={showAnim}>
